...
if __name__ in ("__main__", "sudothinkprofile"):
    import sudoui
    import sudorules as rules
    from sudorules import Sudoku_Error
    import sudoui as ui
    from sudotest import *
elif __name__ == "sudosimu.sudothinkprofile":
    ...
    raise Exception("Impossible de faire les imports dans le module sudothinkprofile.")


class SudoThinkProfile():
...
if __name__ == "__main__":
    thprof = SudoThinkProfile()
    thprof.name()
    print(thprof)
    thprof.name("Mon profil de pensée")
    thprof.name()
    print(thprof)
