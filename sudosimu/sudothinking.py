...
----------
08/12/2017
Le retour de ai.decideAction est modifié pour prendre en compte la vérification
de grille terminée, qui est décidée dans le module 'thinkai'. La fonction
_endGameDetails() est ajoutée pour cela.
'''
